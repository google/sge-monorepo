...
// Binary vm_container_deploy is meant to update a container into a container specialized VM.
// NOTE: This depends on having gcloud installed and within PATH. This assumption is true in the
// build machines and developers who build push docker images manually in their workstations.
package main
...
import (
	...
	_ "sge-monorepo/build/cicd/sgeb/buildtool" // In order to load the invocation flags.
...
func internalMain() error {
	...
	flag.StringVar(&flags.zone, "zone", "", "Zone where the VM instance is")
...
func validateFlags() error {
	...
	if flags.zone == "" {
		flag.PrintDefaults()
		return fmt.Errorf("flag %q cannot be empty", "zone")
	}
	if flags.container == "" {
		flag.PrintDefaults()
